            ...
            <div class="box-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <?php endif;?>
                        <form action="<?php echo base_url();?>mantenimiento/clientes_normales/store" method="POST">
                            <div class="form-group <?php echo form_error("cedula") != false ? 'has-error':'';?>">
                                <label for="cedula">Cedula:</label>
                                <input type="text" class="form-control"  name="cedula" value="<?php echo set_value("cedula");?>" required="required">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="correo" name="correo" required="required">
                            </div>
                            <div class="form-group">
