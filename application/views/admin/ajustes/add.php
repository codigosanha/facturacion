                                    ...
                                    <?php if (!empty($productos)): ?>
                                        <?php foreach ($productos as $producto): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="hidden" name="precios_compras[]" value="<?php echo $producto->precio_compra;?>">
                                                ...
                                                <td>
                                                    <input type="text" name="importes[]" class="form-control" value="0" readonly="readonly">
                                                </td>
                                            </tr>
                                        <?php endforeach ?>
                                    <?php endif ?>
