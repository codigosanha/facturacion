                                    ...
                                    <?php if (!empty($ajustes)): ?>
                                        <?php foreach ($ajustes as $ajuste): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="hidden" name="precios_compras[]" value="<?php echo $ajuste->precio_compra;?>">
                                                    <?php echo $ajuste->precio_compra;?>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <input type="text" name="importes[]" class="form-control" value="<?php echo $ajuste->importe;?>" readonly="readonly">
                                                </td>
                                            </tr>
                                        <?php endforeach ?>
                                    <?php endif ?>
