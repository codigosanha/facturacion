                    ...
                    <div class="col-md-12">
                        ...
                        <form action="<?php echo base_url();?>administrador/comprobantes/update" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="aviso" name="aviso" value="<?php echo $comprobante->aviso ?>">
                            </div>
                            <div class="form-group">
                                <label class="checkbox-inline">
                                    <input type="checkbox" value="<?php echo $comprobante->solicitar_cliente;?>" name="solicitar_cliente" id="solicitar_cliente" <?php echo $comprobante->solicitar_cliente == 1 ? 'checked':'';?>>Solicitar informacion del cliente (RNC / Razon Social)
                                </label>
                            </div>
                            <div class="form-group">
