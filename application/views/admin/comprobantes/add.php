                    ...
                    <div class="col-md-12">
                        ...
                        <form action="<?php echo base_url();?>administrador/comprobantes/store" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="aviso" name="aviso">
                            </div>
                            <div class="form-group">
                                <label class="checkbox-inline">
                                    <input type="checkbox" value="0" name="solicitar_cliente" id="solicitar_cliente">Solicitar informacion del cliente (RNC / Razon Social)
                                </label>
                            </div>
                            <div class="form-group">
