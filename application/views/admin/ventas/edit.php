    ...
    <section class="content">
        ...
        <div class="box box-solid">
            <div class="box-body">
                <div class="row">
                    <div class="col-md-8">
                        <form action="<?php echo base_url();?>movimientos/ventas/update" method="POST" id="form-add-venta">
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group has-feedback">
                                        ...
                                        <input type="text" class="form-control" id="rnc" name="rnc" autocomplete="false" value="<?php echo $venta->razon_social;?>" disabled>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <input type="hidden" name="total" value="<?php echo $venta->monto;?>">
                            ...
                            <div class="form-group text-center">
                                ...
                                <button type="button" class="btn btn-warning" id="save-venta-pendiente">Poner en Espera</button>
